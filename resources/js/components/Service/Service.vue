			...
			<div class="row">
                 <div class="card col-md-12">
                    ...
                    <hr>
					 ...
					 <div class="row">
					 	<div class="col-5">
					 		  <div class="pb-5"><h6 class="card-title">Customer Name</h6>
					           <p class="card-text  text-secondary">{{ service.customer_name}}</p></div>

							   <div class="pb-5"><h5 class="card-title">Customer Phone</h5>
							   <p class="card-text  text-secondary">{{ service.customer_phone}}</p></div>

							   <div class="pb-5"><h5 class="card-title">Customer Address</h5>
							   <p class="card-text  text-secondary">{{ service.township}}</p></div>

							   <div class="pb-5"><h5 class="card-title">Staff</h5>
